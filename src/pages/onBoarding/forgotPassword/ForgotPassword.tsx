...
import { forgotPasswordConfirmOTP, resetPassword } from "../../../containers/onBoardingApi";
       ...
       {/* Ticket Summary */}
                {selectedTicketId && checkoutStage==='eventDetails' && (
                  ...
                  <p className="text-softRed text-[14px] text-left">
                    You're almost done, just reset your password and login to complete your purchase.
                  </p>
                </div>
                )}
      {/* {step === 1 && (
